...
namespace ETABS.Import.Metadata
{
    ...
    public class ETABSToUnits
    {
        ...
        /// </summary>
        /// <param name="etabsUnit">ETABS force unit</param>
        /// <returns>Model force unit</returns>
        ...
        /// </summary>
        /// <param name="etabsUnit">ETABS length unit</param>
        /// <returns>Model length unit</returns>
        ...
        /// </summary>
        /// <param name="etabsUnit">ETABS temperature unit</param>
        /// <returns>Model temperature unit</returns>
        ...
        /// </summary>
        /// <param name="fromUnit">Source force unit</param>
        /// <param name="toUnit">Target force unit</param>
        /// <returns>Scale factor to convert from source to target unit</returns>
        ...
        /// </summary>
        /// <param name="fromUnit">Source length unit</param>
        /// <param name="toUnit">Target length unit</param>
        /// <returns>Scale factor to convert from source to target unit</returns>
