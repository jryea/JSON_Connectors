...
using ETABS.ToETABS.ModelLayout;
using ETABS.ToETABS.Elements;
using ETABS.ToETABS.Metadata;
using ETABS.ToETABS.Loads;
using ETABS.ToETABS.Properties;
using ETABS.Utilities;

namespace ETABS.ToETABS
{
    /// <summary>
    ...
    {
        private readonly ControlsToETABS _controlsToETABS;
        private readonly StoriesToETABS _storiesToETABS;
        private readonly GridsToETABS _gridsToETABS;
        private readonly DiaphragmsToETABS _diaphragmsToETABS;
        private readonly MaterialsToETABS _materialsToETABS;
        private readonly FramePropertiesToETABS _framePropertiesToETABS;
        private readonly WallPropertiesToETABS _wallPropertiesToETABS;
        private readonly FloorPropertiesToETABS _floorPropertiesToETABS;
        private readonly LoadPatternsToETABS _loadPatternsToETABS;
        private readonly LoadCasesToETABS _loadCasesToETABS;
        private readonly LoadCombinationsToETABS _loadCombinationsToETABS;
        private readonly ShellPropsToETABS _shellPropsToETABS;
        private readonly PointCoordinatesToETABS _pointCoordinatesToETABS;
        ...
        public ModelToETABS()
        {
            ...
            _storiesToETABS = new StoriesToETABS();
            _gridsToETABS = new GridsToETABS();
            _diaphragmsToETABS = new DiaphragmsToETABS();
            _materialsToETABS = new MaterialsToETABS();
            _framePropertiesToETABS = new FramePropertiesToETABS();
            _wallPropertiesToETABS = new WallPropertiesToETABS();
            _floorPropertiesToETABS = new FloorPropertiesToETABS();
            _loadPatternsToETABS = new LoadPatternsToETABS();
            _loadCasesToETABS = new LoadCasesToETABS();
            _loadCombinationsToETABS = new LoadCombinationsToETABS();
            _shellPropsToETABS = new ShellPropsToETABS();
        ...
        public string ExportToE2K(BaseModel model)
        {
            try
            {
                ...
                var lineElementsToETABS = new LineElementsToETABS(_pointCoordinatesToETABS);
