...
{
    public class FloorImporter : IRAMImporter<List<Floor>>
    {
        private IModel _model;
        private Dictionary<int, string> _floorTypeIdMap;
        private Dictionary<int, string> _floorPropertyIdMap;

        public FloorImporter(IModel model, Dictionary<int, string> floorTypeIdMap, Dictionary<int, string> floorPropertyIdMap)
        {
            _model = model;
