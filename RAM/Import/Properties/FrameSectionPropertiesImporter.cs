...
{
    public class FrameSectionPropertiesImporter : IRAMImporter<List<FrameProperties>>
    {
        private IModel _model;
        private Dictionary<int, string> _materialIdMap;

        public FrameSectionPropertiesImporter(IModel model, Dictionary<int, string> materialIdMap)
        {
            _model = model;
