...
namespace Revit.Export
{
    public class GrasshopperExporter
    {
        ...
        /// <param name="dwgFolder">Folder to save CAD files</param>
        /// <param name="floorTypes">Floor types to include in the model</param>
        /// <param name="selectedLevels">Levels to include in the model with FloorTypeId already set</param>
        /// <param name="referencePoint">Reference point for the model</param>
        /// <param name="floorTypeToViewMap">Mapping between floor type IDs and view IDs</param>
        /// <param name="selectedLevelIds">Revit element IDs of selected levels</param>
            ...
            List<ElementId> selectedLevelIds = null)
        {
            try
            {
                ...
                // Add the pre-configured levels directly to the model
                // The FloorTypeId is already set on these levels
